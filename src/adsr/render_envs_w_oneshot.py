...
OUT_DIR = Path("../../rendered_adsr_dataset")
...
if __name__ == "__main__":
    ...
    timbre_content_path = "../../rendered_one_shot"
    ...
    # Timbre-content pairs: 1547
    for tc_pair in timbre_content_pairs: # 1547
        ...
        c = 0
        for env_data in envelopes_metadata: # 600
